      ...
      <main className="pt-20">
        ...
        <section className="py-12 bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-900 dark:to-slate-800">
          <div className="container mx-auto px-4 text-center">
            ...
            <h1 className="text-4xl font-bold mb-4">Discover D2C Brands</h1>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Explore our curated collections, discover new brand spotlights, and browse by categories to find the perfect direct-to-consumer brands for your needs.
            </p>
          </div>
        </section>
